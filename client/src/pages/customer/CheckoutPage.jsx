...
export default function CheckoutPage() {
  ...
  const validate = () => {
    ...
    if (!tableNumber) return 'No table selected. Please scan your cafe QR code.';
    if (!diningSessionToken) return 'Please verify that you are inside the cafe before ordering.';
    return null;
  };
